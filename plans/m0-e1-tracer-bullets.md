...
- [x] #16 完成 PostgreSQL 并发、迁移、静态、全量、E2E、秘密扫描、可选 SMTP smoke 边界和 Standards + Spec 双轴证据；SMTP 因未获显式 opt-in/收件人/秘密授权记录为 1 skipped，正式复审无未解决 hard finding，完整证据见 `docs/new_engine/20_AUTH_BASELINE_EVIDENCE.md`。
