...
> 结构说明：本文按“事实 / 评价 / 设计去向”整理。凡涉及 New_Mud 当前领域概念，以根目录 `CONTEXT.md` 为词汇权威；产品范围和产品语义以 `requirements_v6.md` 为权威，其中身份产品语义见第八章；`UBIQUITOUS_LANGUAGE.md` 仅作非权威工程术语索引；`Prototype` 在本文中仅作为 Evennia 来源名词。
