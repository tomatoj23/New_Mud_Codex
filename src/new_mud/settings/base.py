...
AUTH_BASELINE_CUTOVER_ENABLED = os.getenv("NEW_MUD_AUTH_BASELINE_CUTOVER_ENABLED", "0") == "1"
...
AUTH_VERIFICATION_HEARTBEAT_MAX_AGE_SECONDS = int(
    os.getenv("NEW_MUD_VERIFICATION_HEARTBEAT_MAX_AGE_SECONDS", "30")
)
AUTH_VERIFICATION_PROVIDER_RETRY_SECONDS = int(
    os.getenv("NEW_MUD_VERIFICATION_PROVIDER_RETRY_SECONDS", "30")
)
AUTH_VERIFICATION_PROVIDER_PROBE_LEASE_SECONDS = int(
    os.getenv("NEW_MUD_VERIFICATION_PROVIDER_PROBE_LEASE_SECONDS", "15")
)
