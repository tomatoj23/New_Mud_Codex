...
class ProtocolErrorsActionDomain(StrEnum):
    ...
    COMMUNITY_ACTION_FORBIDDEN = "COMMUNITY_ACTION_FORBIDDEN"
    ...
    PLAYER_BLOCK_INVALID = "PLAYER_BLOCK_INVALID"
    CHANNEL_MUTE_INVALID = "CHANNEL_MUTE_INVALID"
    MODERATION_REPORT_INVALID = "MODERATION_REPORT_INVALID"
    MODERATION_CASE_NOT_FOUND = "MODERATION_CASE_NOT_FOUND"
    MODERATION_APPEAL_ALREADY_SUBMITTED = "MODERATION_APPEAL_ALREADY_SUBMITTED"
    MODERATION_APPEAL_FORBIDDEN = "MODERATION_APPEAL_FORBIDDEN"
...
class ProtocolErrorsAuthenticationPresence(StrEnum):
    ...
    CHARACTER_CREATION_UNAVAILABLE = "CHARACTER_CREATION_UNAVAILABLE"
    CHARACTER_DISPLAY_NAME_INVALID = "CHARACTER_DISPLAY_NAME_INVALID"
    CHARACTER_PROFILE_INVALID = "CHARACTER_PROFILE_INVALID"
    ...
    PRESENCE_RECOVERY_UNAVAILABLE = "PRESENCE_RECOVERY_UNAVAILABLE"
    RECOVERY_CODE_RETIRED = "RECOVERY_CODE_RETIRED"
    ACCOUNT_REOPEN_WINDOW_EXPIRED = "ACCOUNT_REOPEN_WINDOW_EXPIRED"
    ACCOUNT_NOT_REOPENABLE = "ACCOUNT_NOT_REOPENABLE"
    ACCOUNT_ALREADY_RETIRED = "ACCOUNT_ALREADY_RETIRED"
...
class ProtocolErrorsRetiredAuthenticationProvenance(StrEnum):
...
class ProtocolRequestTypes(StrEnum):
    ...
    PRESENCE_RECOVER = "presence.recover"
